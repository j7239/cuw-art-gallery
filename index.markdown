            ...
            <div class="container">
                ...
                <div class="row d-flex">
                    ...
                    <div class="order-1 order-sm-2 d-flex align-items-center col-md-4 col-sm-4 col-xs-12">
                        <div class="intro-img mb-3 mb-sm-0 wow fadeInRight" data-wow-duration="1000ms"> <img src="img/img2.jpg" alt=""> </div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="blog" class="section">
            ...
            <div class="container">
                <div class="section-header">
                    ...
                    {%- if page.upcoming_exhibits -%}
                    <p class="section-subtitle wow fadeIn">{{upcoming_exhibits}}</p>
                    {%- endif -%}
                </div>
                <div class="row d-flex">
        ...
        <section id="portfolios" class="section">
            ...
            <div class="container">
                <div class="section-header">
                    ...
                    <hr class="lines wow zoomIn">
                    {%- if page.archive -%}
                    <p class="section-subtitle wow fadeIn">{{archive}}</p>
                    {%- endif -%}
                </div>
                <div class="row">
                    <div class="col-md-12">
